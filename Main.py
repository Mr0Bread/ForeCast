...
if __name__ == '__main__':
    ...
    list_of_lists_of_values = DataHandler.get_list_of_chosen_values(main_info, 'Dew Point')
    list_of_lists_of_time = DataHandler.get_list_of_chosen_values(main_info, 'Time')
